...
import styles from './BurnToMintPage.module.scss'
import Icon from '@/components/UI/Icon/Icon'
import { useAuth } from './BurnCandy/hooks/useAuth'
import { useCandy } from './BurnCandy/hooks/useCandy'
import { WalletMultiButton, useWalletModal } from '@solana/wallet-adapter-react-ui';
import '@solana/wallet-adapter-react-ui/styles.css';
import { useWallet } from '@solana/wallet-adapter-react';
import { umiPubkeyFromWalletAdapterPubkey, umiSignerFromSolanaWalletAdapter } from './BurnCandy/lib/utils';
import { CreateMintTransactionParams, MintingResult } from './BurnCandy/types/create_mint';
import { PublicKey, base58PublicKey, generateSigner } from '@metaplex-foundation/umi';
import { useAuthStore } from '@/store/store';
import { useWalletMultiButton } from '@solana/wallet-adapter-base-ui';
import ImageMy from '@/components/Image/ImageMy';
import HashAnchor from '@/components/HashAnchor/HashAnchor';
import MintModal from '../MintPage/components/MintModal/MintModal';
...
export default function BurnToMintPage({data}: {data: any}) {
