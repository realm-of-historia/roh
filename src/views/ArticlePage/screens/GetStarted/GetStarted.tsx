        ...
        <div className={styles.getStarted}>
            <div className={styles.container}>
                <div className={styles.left}>
                    ...
                    <Text><p className={styles.title}>Admin Panel — How to get started tutorial. Create a customizable SaaS Based applications and solutions </p></Text>
